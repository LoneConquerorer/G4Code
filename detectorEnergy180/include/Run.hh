...
class Run : public G4Run
{
  ...
  public:
    ...
    void output_to_file(G4double);
    void output_to_file(G4double, G4double);
    void output_to_file(G4double, G4double,G4double);
    void output_to_file(G4String,G4double,G4double,G4int);
    void output_to_file(G4double,G4double,G4double,G4double,
                        G4double,G4double,G4double,G4double,
                        G4double,G4double,G4double,G4double,
                        G4double,G4double,G4double,G4double);
    void output_to_file_Triple_Only(G4double,G4double,G4double,G4double,
                        G4double,G4double,G4double,G4double,
                        G4double,G4double,G4double,G4double,
                        G4double,G4double,G4double,G4double);
    void output_to_file_Quad_Only(G4double,G4double,G4double,G4double,
                        G4double,G4double,G4double,G4double,
                        G4double,G4double,G4double,G4double,
                        G4double,G4double,G4double,G4double);				
  ...
  private:
    ...
    std::vector<G4String>    sPartName;
    std::vector<G4double>    sEdepDet;
    std::vector<G4double>    sTimeDet;
    std::vector<G4int>       sDetNum;
