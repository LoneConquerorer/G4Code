...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void Run::output_to_file(G4double energy)
{
...
void Run::output_to_file(G4double energy1, G4double energy2)
{
  std::ofstream out_data;
  out_data.open("OutputEnergy.txt", std::ios_base::app);

  out_data <<energy1/keV<<"\t"<<energy2/keV<<"\n";

}

void Run::output_to_file(G4double energy1, G4double energy2, G4double dTime)
{
  std::ofstream out_data;
  out_data.open("OutputEnergy.txt", std::ios_base::app);

  out_data <<energy1/keV<<"\t"<<energy2/keV<<"\t"<<G4BestUnit(dTime,"Time")<<"\n";

}


void Run::output_to_file(G4String name, G4double energy, G4double time1, G4int iVol)
{
  std::ofstream out_data;
  out_data.open("Output.txt", std::ios_base::app);

  sPartName.push_back(name);
  sEdepDet.push_back(energy);
  sTimeDet.push_back(time1);
  sDetNum.push_back(iVol);


if(energy>0)
{
         out_data <<" Name:" << name << std::setw(15)
                  << "Energy:"<< G4BestUnit(energy,"Energy") << std::setw(15)
                  << "Time: " << G4BestUnit(time1,"Time") << std::setw(15)
                  << "Detector#: " << iVol<<"\n";
}
...
void Run::output_to_file(G4double EdepLaBr1,   G4double EdepLaBr2,
                            G4double EdepNaI1, G4double EdepNaI2,
                            G4double EdepNaI3, G4double EdepNaI4,
                            G4double EdepNaI5, G4double EdepNaI6,
                            G4double TimeLaBr1,G4double TimeLaBr2,
                            G4double TimeNaI1, G4double TimeNaI2,
                            G4double TimeNaI3, G4double TimeNaI4,
                            G4double TimeNaI5, G4double TimeNaI6)
{
  std::ofstream out_data;
  out_data.open("Output_Test.txt", std::ios_base::app);
/*
  out_data <<"17\n"
           << EdepLaBr1/keV << "\n"
           << EdepLaBr2/keV << "\n"
...
void Run::output_to_file_Triple_Only(G4double EdepLaBr1,   G4double EdepLaBr2,
                            G4double EdepNaI1, G4double EdepNaI2,
                            G4double EdepNaI3, G4double EdepNaI4,
                            G4double EdepNaI5, G4double EdepNaI6,
                            G4double TimeLaBr1,G4double TimeLaBr2,
...
void Run::output_to_file_Quad_Only(G4double EdepLaBr1,   G4double EdepLaBr2,
                            G4double EdepNaI1, G4double EdepNaI2,
                            G4double EdepNaI3, G4double EdepNaI4,
                            G4double EdepNaI5, G4double EdepNaI6,
                            G4double TimeLaBr1,G4double TimeLaBr2,
