...
RunAction::RunAction(DetectorConstruction* det, PrimaryGeneratorAction* prim, EventAction* eAct)
   : G4UserRunAction(),
   fGamma(0), fElectron(0), fPositron(0),
   fDetector(det), fPrimary(prim), fProcCounter(0), fAnalysisManager(0), eventAct(eAct),
   fTotalEventCount(0),
   fPhotonStats(), fElectronStats(), fPositronStats()
{
   fGamma = G4Gamma::Gamma();
...
void RunAction::output_to_file_Triple_Only(G4double EdepLaBr1, G4double EdepLaBr2, G4double EdepNaI1, G4double EdepNaI2, G4double EdepNaI3, G4double EdepNaI4, G4double EdepNaI5, G4double EdepNaI6, G4double EdepNaI7, G4double EdepNaI8, G4double EdepNaI9)
{
   std::ofstream out_data;
   out_data.open("Output_Test_Triple.txt", std::ios_base::app);

   out_data << EdepLaBr1 / keV << "\t"
      << EdepLaBr2 / keV << "\t"
      << EdepNaI1 / keV << "\t"
      << EdepNaI2 / keV << "\t"
      << EdepNaI3 / keV << "\t"
...
void RunAction::output_to_file_Quad_Only(G4double EdepLaBr1, G4double EdepLaBr2, G4double EdepNaI1, G4double EdepNaI2, G4double EdepNaI3, G4double EdepNaI4, G4double EdepNaI5, G4double EdepNaI6, G4double EdepNaI7, G4double EdepNaI8, G4double EdepNaI9)
{
   std::ofstream out_data;
...
void RunAction::output_to_file_Quad_Only_12(G4double EdepLaBr1, G4double EdepLaBr2, G4double EdepNaI1, G4double EdepNaI2, G4double EdepNaI3, G4double EdepNaI4, G4double EdepNaI5, G4double EdepNaI6, G4double EdepNaI7, G4double EdepNaI8, G4double EdepNaI9)
{
   std::ofstream out_data;
   out_data.open("Output_Test_Quads_12.txt", std::ios_base::app);
...
void RunAction::output_to_file_Quad_Only_13(G4double EdepLaBr1, G4double EdepLaBr2, G4double EdepNaI1, G4double EdepNaI2, G4double EdepNaI3, G4double EdepNaI4, G4double EdepNaI5, G4double EdepNaI6, G4double EdepNaI7, G4double EdepNaI8, G4double EdepNaI9)
{
   std::ofstream out_data;
   out_data.open("Output_Test_Quads_13.txt", std::ios_base::app);
...
void RunAction::output_to_file_Quad_Only_14(G4double EdepLaBr1, G4double EdepLaBr2, G4double EdepNaI1, G4double EdepNaI2, G4double EdepNaI3, G4double EdepNaI4, G4double EdepNaI5, G4double EdepNaI6, G4double EdepNaI7, G4double EdepNaI8, G4double EdepNaI9)
{
   std::ofstream out_data;
   out_data.open("Output_Test_Quads_14.txt", std::ios_base::app);
...
void RunAction::output_to_file_Quad_Only_15(G4double EdepLaBr1, G4double EdepLaBr2, G4double EdepNaI1, G4double EdepNaI2, G4double EdepNaI3, G4double EdepNaI4, G4double EdepNaI5, G4double EdepNaI6, G4double EdepNaI7, G4double EdepNaI8, G4double EdepNaI9)
{
   std::ofstream out_data;
   out_data.open("Output_Test_Quads_15.txt", std::ios_base::app);
...
void RunAction::output_to_file_Quad_Only_16(G4double EdepLaBr1, G4double EdepLaBr2, G4double EdepNaI1, G4double EdepNaI2, G4double EdepNaI3, G4double EdepNaI4, G4double EdepNaI5, G4double EdepNaI6, G4double EdepNaI7, G4double EdepNaI8, G4double EdepNaI9)
{
   std::ofstream out_data;
   out_data.open("Output_Test_Quads_16.txt", std::ios_base::app);
...
void RunAction::output_to_file_Quad_Only_17(G4double EdepLaBr1, G4double EdepLaBr2, G4double EdepNaI1, G4double EdepNaI2, G4double EdepNaI3, G4double EdepNaI4, G4double EdepNaI5, G4double EdepNaI6, G4double EdepNaI7, G4double EdepNaI8, G4double EdepNaI9)
{
   std::ofstream out_data;
   out_data.open("Output_Test_Quads_17.txt", std::ios_base::app);
...
void RunAction::output_to_file_Quad_Only_18(G4double EdepLaBr1, G4double EdepLaBr2, G4double EdepNaI1, G4double EdepNaI2, G4double EdepNaI3, G4double EdepNaI4, G4double EdepNaI5, G4double EdepNaI6, G4double EdepNaI7, G4double EdepNaI8, G4double EdepNaI9)
{
   std::ofstream out_data;
   out_data.open("Output_Test_Quads_18.txt", std::ios_base::app);
...
void RunAction::output_to_file_Quad_Only_19(G4double EdepLaBr1, G4double EdepLaBr2, G4double EdepNaI1, G4double EdepNaI2, G4double EdepNaI3, G4double EdepNaI4, G4double EdepNaI5, G4double EdepNaI6, G4double EdepNaI7, G4double EdepNaI8, G4double EdepNaI9)
{
   std::ofstream out_data;
   out_data.open("Output_Test_Quads_19.txt", std::ios_base::app);
...
void RunAction::output_to_file_Triple_Only(G4double EdepLaBr1, G4double EdepLaBr2, G4double EdepNaI1, G4double EdepNaI2, G4double EdepNaI3, G4double EdepNaI4, G4double EdepNaI5, G4double EdepNaI6)
{
   std::ofstream out_data;
   out_data.open("Output_Test_Triple.txt", std::ios_base::app);
...
void RunAction::output_to_file_Quad_Only(G4double EdepLaBr1, G4double EdepLaBr2, G4double EdepNaI1, G4double EdepNaI2, G4double EdepNaI3, G4double EdepNaI4, G4double EdepNaI5, G4double EdepNaI6)
{
   std::ofstream out_data;
   out_data.open("Output_Test_Quads.txt", std::ios_base::app);
